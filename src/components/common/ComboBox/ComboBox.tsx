...
const ComboBoxView = (props: any): JSX.Element => {
  ...
  const [ubicationclinica, setubicationclinica] = useState(props.MedicalCenterReducer.id_medical_center?props.MedicalCenterReducer.id_medical_center:dataUser.user.idmedical_center);
