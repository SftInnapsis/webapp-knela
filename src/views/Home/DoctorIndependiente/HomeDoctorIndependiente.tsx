...
import { ROUTE_PATIENT,ROUTE_PATIENT_INDEPENDIENTE, ROUTE_PATIENT_MASTER } from '@constants/route-map';
import Paper from '@mui/material/Paper';
import Fade from '@mui/material/Fade';
import { Link } from "react-router-dom";
import ArrowBackIosIcon from "@mui/icons-material/ArrowBackIos";
import FavoriteIcon from "@mui/icons-material/Favorite";
import "./HomeDoctorIndependiente.css";
...
import {ROUTE_ATTENTION_KNELA} from '@constants/route-map';
...
export const HomeDoctorIndependienteView = (props) => {
    ...
    const seleccionarPaciente = (elemento) => {
        ...
        history.push(ROUTE_PATIENT_INDEPENDIENTE, { dataPaciente: elemento });
    };
    ...
    const createAttention = () => {
        history.push(ROUTE_ATTENTION_KNELA, {idMedical:30})
    }
                    ...
                    <Grid item xs={12} md={10}>
                        ...
                        <Grid container mt={4}>
                            ...
                            <Grid container justifyContent="flex-end">
                                    {/* <Button onClick={()=>{createAttention()}}>Crear Atención</Button> */}
                                    <Typography sx={{ color: '#28c4ac', pt:1 }} onClick={()=>{createAttention()}} fontSize='18px' fontWeight={'bold'} id="parent-modal-title">Crear Atención</Typography>
                                    <IconButton type="button" onClick={()=>{createAttention()}}>
                                    <AddCircleIcon />
                                </IconButton>
                            </Grid>
