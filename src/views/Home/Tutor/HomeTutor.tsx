...
export const HomeTutorView = (props) => {
    ...
    const getAttentionOpen = async() =>{
        ...
        const res = await attentionService.getAttentionPatienByTutor(MedicalCenterReducer.id_medical_center,dataUser?.user?.id_tutor);
       if(res && res.data)
       {
